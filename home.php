    ...
    <div class="tp-banner">
        <ul>
            ...
            <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Care your family">
                <!-- MAIN IMAGE -->
                <img src="images/bg-11.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                <div  class="caption slider-title dark sft"
                    ...
                    <!--                            Daffodil International University Campus <br>--><br>
                    <span class="colored-text" style="color:firebrick">Learn Better</span>
                </div>
                ...
                <div class="caption slider-caption dark sfl"
                     ...
                     data-start="1800"
                     data-easing="easeOutExpo">
                    The mission of Campus Life is to encourage the intellectual <br> and social development of students, individually and through student groups
                </div>
                <div class="caption sfb rev-buttons tp-resizeme"
                    ...
                    <a href="https://daffodilvarsity.edu.bd" class="btn btn-skin btn-lg" target="_blank">Learn more <i class="fa fa-angle-right"></i></a>
                </div>
            ...
            <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Solid team">
                <!-- MAIN IMAGE -->
                <img src="images/bg-2.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <div class="caption slider-title light sft"
                    ...
                    <span class="colored-text">Easily with SCC</span>
                </div>
                ...
                <div class="caption slider-caption light sfl"
                     ...
                     data-start="1800"
                     data-easing="easeOutExpo">
                    Our central belief is that students who are actively involved in campus life <br> will find their experience at DIU to be more satisfying and successful.  
                </div>
                <div class="caption sfb rev-buttons tp-resizeme"
                     data-x="50"
                     data-y="380"
                     ...
                     data-start="1800"
                     data-easing="Sine.easeOut">
                    <a href="#" class="btn btn-skin btn-lg">Learn more <i class="fa fa-edit"></i></a>
                    <!--<a href="#" class="btn btn-skin btn-lg">Apply Now <i class="fa fa-edit"></i></a>-->
                </div>
            </li>
            <!-- SLIDE -->
            <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Quality Services">
                <!-- MAIN IMAGE -->
                <img src="images/bg-7.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <div class="caption slider-title dark sft"
                     ...
                     data-start="1000"
                     data-easing="easeOutExpo">
                    SCC <span class="colored-text">A trusted Brand</span>
                ...
                <div class="caption sfb rev-buttons tp-resizeme"
                     ...
                     data-start="1800"
                     data-easing="Sine.easeOut">
                    <a href="#" class="btn btn-skin btn-lg">View Services <i class="fa fa-cogs"></i></a>
                </div>
