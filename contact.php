            ...
            <div class="row contact-row">
                <div class="col-sm-8 margin-btm-30">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                             <label>Phone</label>
                            <input type="text" class="form-control" placeholder="(01) 3494-393-332">
                        </div>
                        <div class="form-group">
                            <label>Message</label>
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    ...
                    <p class="adr">
                                    <span class="adr-group">       
                                        <span class="street-address">59/A/1, West Rajabazar</span><br>
                                        
                                        <span class="postal-code">Dhaka 1215</span><br>
                                        <span class="country-name">Bangladesh</span>
                                    </span>
                    </p><hr>
                    <h5>Enquiries</h5>
                    <p>+8801616789387</p>
                    <p><a href="#">alamin.iyakub@diu.edu.bd</a></p>
                    <hr>
                    <h5>Social</h5>
