...
<!-- Mirrored from bootstraplovers.com/templates/assan-v2.4/assan-education/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2016 19:31:42 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <div class="login-register-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 login_social">
                                    <a href="#" class="btn btn-twitter btn-block "><i class="fa fa-twitter"></i>Twitter</a>
                                </div>
                            </div>
                            ...
                            <button type="button" class="btn btn-lg btn-block btn-skin">Login</button>
                          
                        </form>
                        <a href="#" class="btn btn-lg btn-link btn-block">Create Account!</a>
                    </div>
                </div>
